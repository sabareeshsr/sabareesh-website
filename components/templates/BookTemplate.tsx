...
export default function BookTemplate({ heroTitle, heroSubtitle, books, sections, pageSections, badge = 'Creative Writing' }: BookTemplateProps) {
  return (
